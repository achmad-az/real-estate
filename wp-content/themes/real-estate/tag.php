...
?>
<div id="tag-archives" class="theme-dark w-full">
        ...
        <div class="container-content relative py-12">
			<header class="w-full">
				<h1 class="text-[--theme-text-prm-color] typography-h2 tracking-wide mb-[20px]">
					<?php
					printf(
						esc_html__( 'Tag: %s', GNS_TEXT_DOMAIN ),
						'<span class="tag-term">' . esc_html( $name ) . '</span>'
					);
					?>
				</h1>
			</header><!-- .page-header -->

			<div class="tag-archives-content flex justify-center w-full pt-8 pb-[104px] mx-auto">
