...
<div class="break-inside-avoid bg-white shadow-md rounded-lg overflow-hidden p-5 transition-all duration-300 hover:shadow-lg">
    ...
    <div class="p-4">
        <h4 class="typography-h4 text-[#141414] line-clamp-2 mb-4">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="<?php the_permalink(); ?>" class="text-[#141414] bg-[--theme-primary-color] px-4 py-2 rounded hover:bg-opacity-90">
                Read Now
            </a>
        </div>
    </div>
